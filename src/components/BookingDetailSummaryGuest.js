...
function BookingDetailSummary(props) {
    ...
    const updateChefs = async (chef_id) => {
        setLoading(true)
        try {
            let data = await fetch(`${process.env.REACT_APP_BASE_URL}user/guest_get_chef_detail`,
                {
                    method: 'POST',
                    headers: {
            ...
            callErrorApi(`catch_error: ${process.env.REACT_APP_BASE_URL}user/guest_get_chef_detail`, "Guest", error);
        }
    }
    ...
    const bookChef = async (e) => {
        ...
        if (localStorage.getItem("card_added") === 0) {
            ...
            formdata.append("instructions_for_chef", instructions_for_chef);
            ...
            try {
                ...
                if (data.status === true) {
                    ...
                    callErrorApi(`response_error: ${process.env.REACT_APP_BASE_URL}book/book_chef`, "Guest", data);
                    setIsSubmitting(false);
                }
            } catch (error) {
                callErrorApi(`catch_error: ${process.env.REACT_APP_BASE_URL}book/book_chef`, "Guest", error);
                setIsSubmitting(false);
            }
        }
        setIsSubmitting(false)
                ...
                <div className="edit_btn">
                    {showBreakup ? <>
                        <div className="d-flex justify-content-between align-items-center">
                            <p>Base Charge</p>
                            <p style={{ fontWeight: 700 }}>${base_charge}</p>
                        </div>
                        <div className="d-flex justify-content-between align-items-center">
                            <p>Service Fee</p>
                            <p style={{ fontWeight: 700 }}>${service_fees}</p>
                        </div>
                        {chef_grocery_pickup === "Yes" ? <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" className="btn btn-orange text-center rounded-pill mb-1" onClick={localStorage.getItem("token") ? bookChef : redirectSignin}
                        style={{ width: "100%", margin: "auto" }} disabled={isSubmitting}>{isSubmitting ? (
                            <span className="spinner-border spinner-border-sm"></span>
                        ) : (
                            ""
                        )}{localStorage.getItem("token") ? "" : <MdLockOutline />} Confirm Booking </button>
                        ...
                        <form id="profile-chef-complete">
                            ...
                            <div className="box_title py-2 my-2"
                                style={{
                                    ...
                                    borderRadius: "15px", width: isMobile ? "95%" : "90%", margin: "auto"
                                }}>
                            ...
                            <div className="form_box" style={{ width: isMobile ? "95%" : "90%", margin: "auto" }}>
                                    ...
                                    {menu_item.map((element, index) => {
                                        return <div className="row my-1" key={index} >
                                            ...
                                            <div className={isMobile ? "col-4 d-flex justify-content-end" : "col-4 d-flex justify-content-center"}>
                                                <select defaultValue={element.portion}>
                                ...
                                <div className="mb-3 mt-5 pt-3"  >
                                    ...
                                    <input type="text" className="form-control shadow-none" id="Input" style={{
                                        borderRadius: "15px", backgroundColor: "rgba(128, 128, 128,0.4)"
                                    }} placeholder="Enter Allergies" defaultValue={allergies} />
                                </div>

                                <div className="mb-3 pt-3"  >
                                    <label htmlFor="Input" className="form-label fw-bold">Do you want the chef to pick up
                                        groceries? </label>
                                ...
                                {isMobile ? null :
                                    <>
                                        ...
                                        <div className="box_title py-2 my-4 d-flex justify-content-center py-5"
                                            ...
                                            <table width="80%">
                                                <tbody>
                                                    ...
                                                    {chef_grocery_pickup === "Yes" || groceryFees ? <tr className="">
                                        ...
                                        <div className="edit_btn mt-5 text-center">
                                            <button type="button" className="btn btn-orange rounded-pill mb-1" onClick={localStorage.getItem("token") ? bookChef : redirectSignin}
